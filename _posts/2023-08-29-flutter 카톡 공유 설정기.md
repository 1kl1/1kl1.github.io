...
<img src="./2023-08-29-flutter 카톡 공유 설정기.assets/message-type-20231004213711284.png" alt="img" style="zoom:40%;" />
...
![img](./2023-08-29-flutter 카톡 공유 설정기.assets/message_template_link.png)

이 사진이 의미하는 것은 결국 카카오톡 공유는 딥 링크의 일종이라는 것 입니다. 
사실 이 사실을 알기 전 까지는 Firebase의 dynamic link를 이용하여 Uri link를 만들었고, 해당 링크를 kakaotalk 공유로 넣는 방식으로 구현하고 있었습니다. 

 이제는 그 사실을 알게 되었으니 직접 구현 해 봅니다.
